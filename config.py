...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8372937428:AAHGjK4__aJpUzHggLSYA5ILA51Hv5PBMbo")
APP_ID = int(os.environ.get("APP_ID", "24810254")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "aadb42caec01695fa0a77c09b3e0ef47") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002523329312")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Kaizen_Kouhei") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7543269959")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://shizune080:cINkL8O2wP2yKtyj@cluster0.t4vec.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
